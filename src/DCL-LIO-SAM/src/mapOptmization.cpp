...
public:
    ...
    void publishOdometry()
    {
        ...
        std::ofstream pose_lio;
        if (name == "a"){
            pose_lio.open("/home/slam/6_OutputRes/3_DCL-SLAM/a_tum.txt", std::ios::app);
        }
        else if (name == "b"){
            pose_lio.open("/home/slam/6_OutputRes/3_DCL-SLAM/b_tum.txt", std::ios::app);
        }
        if (name == "c"){
            pose_lio.open("/home/slam/6_OutputRes/3_DCL-SLAM/c_tum.txt", std::ios::app);
        }
        
		pose_lio.setf(std::ios::scientific, std::ios::floatfield);
		pose_lio.precision(9);
		// static double timeStart = laserOdometryROS.header.stamp.toSec();
		// auto T_init =ros::Time().fromSec(timeStart);
		pose_lio << laserOdometryROS.header.stamp << " "
